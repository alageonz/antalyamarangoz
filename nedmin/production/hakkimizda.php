                ...
                <div class="x_content">
                  ...
                  <form action="../netting/islem.php" method="POST" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                      <label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Yüklü foto<br>313x103 px<span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">

                        <?php 
                        if (strlen($hakkimizdacek['hakkimizda_foto'])>0) {?>

                          <img width="200"  src="../../<?php echo $hakkimizdacek['hakkimizda_foto']; ?>">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="file" id="first-name"  name="hakkimizda_foto"  class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>

                    <input type="hidden" name="eski_foto" value="<?php echo $hakkimizdacek['hakkimizda_foto']; ?>">

                    <div align="right" class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                      <button type="submit" name="hakkimizdafotoduzenle" class="btn btn-primary">Güncelle</button>
                    </div>
