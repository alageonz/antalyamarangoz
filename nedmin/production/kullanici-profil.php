            ...
            <div class="x_title">
              ...
              <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="first-name" required="required"  name="kullanici_unvan" value="<?php echo $kullanicicek['kullanici_unvan']; ?>" class="form-control col-md-7 col-xs-12">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="password" id="first-name" name="kullanici_password" placeholder="Şifrenizi değiştirmek isterseniz giriniz..." class="form-control col-md-7 col-xs-12">
                  </div>
                </div>
